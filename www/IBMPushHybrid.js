 ...
 *  IBMPush Service JavaScript SDK v1.0.0
 *
 */
...
// Generated by IBMPush SDK v0.6.18 - template: 'combined' 
...
var hybrid = new IBMHybrid("IBMPushHybrid");
  function IBMPushService() {
  }
  ;
...
define('ibm/mobile/service/IBMPushHybrid', ['require', 'exports', 'module', './push/IBMPushService', './_IBMPush'], function (require, exports, module, IBMPushService, _IBMPush) {
  

if (!(IBMBluemix && Q && _ && IBMHttpRequest && IBMHybrid)) {
  ...
  var IBMPushHybrid = _.extend({}, _IBMPush, {
      ...
      _init: function () {
        var defer = Q.defer();
        try {
          this.hybrid.exec("initialize", []).then(function () {
            this._push = new IBMPushService();
